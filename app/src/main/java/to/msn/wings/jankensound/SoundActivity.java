...
public class SoundActivity extends Activity {
    ...
    static protected MediaPlayer click;       // 選択音用フィールド宣言
    static protected MediaPlayer[] mpResult;// じゃんけん＆勝敗音声用フィールド宣言
    ...
    public void onCreate(Bundle state) {
        ...
        if (mpResult == null) {
            mpResult = new MediaPlayer[] {MediaPlayer.create(this,R.raw.draw),
                    ...
                    MediaPlayer.create(this,R.raw.janken)
            };
        }
        bgm.setLooping(true);
